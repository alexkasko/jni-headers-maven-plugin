 ...
 * another fix for windows ([#1](https://github.com/alexkasko/jni-headers-maven-plugin/issues/1))

**1.0.5** (2013-06-08)

 * fix `javap` and `javah` search for windows ([#1](https://github.com/alexkasko/jni-headers-maven-plugin/issues/1))
